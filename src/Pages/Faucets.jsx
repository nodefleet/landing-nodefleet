                  ...
                  >
                    ...
                    <div className="md:hidden">
                      ...
                      <div className="flex justify-between items-center mb-3">
                        <div className="text-gray-300 font-medium">Network:</div>
                      ...
                      <div className="flex justify-between items-center mb-3">
                        <div className="text-gray-300 font-medium">Node Type:</div>
                      ...
                      <div className="mb-4">
                        <div className="text-gray-300 font-medium mb-2">Public RPC Endpoint:</div>
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        <div className="flex flex-col">
                          <div className="text-gray-300 font-medium mb-2">Faucets:</div>
                            ...
                            {blockchain.faucetLink ? (
                              blockchain.name.toLowerCase() === "snapshot" ? (
                                <>
                                  ...
                                  >
                                    Faucet <i className="fa-solid fa-download"></i>
                                  </a>
                                </>
                                ...
                                <a
                                  ...
                                  className="bg-[#7a65d0] px-3 py-1.5 rounded-xl hover:bg-[#5538ce] transition-colors inline-flex items-center gap-2"
                                >
                                  Faucet <i className="fa-solid fa-arrow-right -rotate-45"></i>
                                </a>
                              ) : (
                                <Link
                        ...
                        <div className="flex flex-col">
                          <div className="text-gray-300 font-medium mb-2">Snapshot:</div>
                          <div className="flex justify-center">
                              ...
                              blockchain.name.toLowerCase() === "snapshot" ? (
                                <>
                                  <a
                                    ...
                                    className="bg-[#7a65d0] px-3 py-1.5 rounded-xl hover:bg-[#5538ce] transition-colors inline-flex items-center gap-2"
                                  >
                                    Snapshot <i className="fa-solid fa-download"></i>
                                  </a>
                                </>
                                ...
                                <a
                                  ...
                                  className="bg-[#7a65d0] px-3 py-1.5 rounded-xl hover:bg-[#5538ce] transition-colors inline-flex items-center gap-2"
                                >
                                  Snapshot <i className="fa-solid fa-arrow-right -rotate-45"></i>
                                </a>
                              ) : (
                                <Link
                                  to={`/faucets/${blockchain.id}`}
